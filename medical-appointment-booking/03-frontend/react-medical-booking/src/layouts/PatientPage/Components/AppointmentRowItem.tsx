  ...
  return (
    ...
    <tr>
      ...
      <td>
        ...
        <Modal show={showModal} handleClose={handleCloseModal}  id={props.id}
                patientId={props.patientId}
                doctorId={props.doctorId}
                patientName={props.patientName} // Corrected prop name
                doctorName={props.doctorName}
                date={props.date} time={props.time} description={props.description} status={props.status}/>

        <Button variant="danger" onClick={() => props.rowCancel(props.id)} disabled={isButtonDisabled}>Cancel</Button>
      </td>
    </tr>
  );
};
